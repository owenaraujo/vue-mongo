                    ...
                    <b-card :class="{ 'dark-secondary': dark }">
                      <div class="text-center">
                        <b-form-input
                          type="text"
                          class="mt-2"
                          v-model="infoEmpresa.nombre"
                        ></b-form-input>
                        <b-form-input
                          type="text"
                          class="mt-2"
                          v-model="infoEmpresa.rif"
                        ></b-form-input>
                        <b-form-input
                          type="text"
                          class="mt-2"
                          v-model="infoEmpresa.telefono"
                        ></b-form-input>
                        <div
                          @click="putEmpresa()"
                          class="
            ...
            <div class="modal-body mx-3">
              ...
              <div :class="{ 'd-none': !formVisibilityEDit }">
                ...
                <div class="d-flex text-white">
                  ...
                  <div
                    @click="formVisibilityEDit = false"
...
export default {
  ...
  methods: {
    ...
    async putEmpresa() {
      const { data } = await axios.put(
        `${this.server}/system/empresa/datos/${this.infoEmpresa._id}`,
        this.infoEmpresa,
        { headers: { xtoken: this.token } }
      );
      this.alert(data);
